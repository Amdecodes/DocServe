        ...
        <div className="flex items-center gap-4">
           ...
           */}
           {isLandingPage ? (
              ...
              <Button asChild className="hidden md:flex bg-blue-500 hover:bg-blue-600 text-white rounded-full px-6 gap-2">
                 <a href="https://t.me/elutesh123" target="_blank" rel="noopener noreferrer">
