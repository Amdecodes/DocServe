  ...
  return (
    ...
    >
      ...
      <div className="flex-1 p-12 pt-16">
        ...
        {summary && (
          <div className="mb-10">
            <h2 className="text-xl font-bold text-[#1F1F1F] mb-4 uppercase tracking-wide">
              About Me
            </h2>
            <AIBlurOverlay
              type="summary"
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-[#1F1F1F] mb-8 uppercase tracking-wide">
            ...
            {experience.length === 0 ? (
              ...
              experience.map((exp, idx) => (
                ...
                >
                  ...
                  <div
                    className={`flex-1 border-l-2 border-gray-200 pl-8 pb-10 ${idx === experience.length - 1 ? "border-l-transparent" : ""}`}
                  >
