                  ...
                  <tr key={order.id} className="hover:bg-gray-50/50 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      ...
                      {order.variation_name && (
                         <div className="text-xs text-gray-500">{order.variation_name}</div>
                      )}
           ...
           <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                 <div>
                    ...
                    <div className="font-semibold text-gray-900">{selectedOrder.full_name}</div>
                    <div className="text-sm text-gray-600">{selectedOrder.phone}</div>
                    {selectedOrder.email && <div className="text-sm text-gray-600">{selectedOrder.email}</div>}
                 </div>
                 <div>
                    <label className="text-xs text-gray-500 font-medium uppercase">Product</label>
                    <div className="font-semibold text-gray-900">{selectedOrder.product_name}</div>
                    {selectedOrder.variation_name && <div className="text-sm text-gray-600">{selectedOrder.variation_name}</div>}
                    <div className="text-sm text-gray-600">Qty: {selectedOrder.quantity}</div>
                 </div>
              </div>

              <div>
                 <label className="text-xs text-gray-500 font-medium uppercase">Delivery Location</label>
